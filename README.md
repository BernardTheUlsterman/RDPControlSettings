...
Maximale Anzeigehöhe des Remote Desktops in Pixel (px). Dieser Wert sollte anhand der gewünschten Auflösung und der Auflösung des vorhandenen Monitors gewählt werden. Vorgegeben sind 2000 px. <br> <br> Wenn Sie die RDP Option Use all my monitors for the remote session verwenden, um mehrere Monitore für den Remote Desktop zu verwenden, beachten Sie bitte, maximale Breite und Höhe der Anzeige entsprechend gross zu dimensionieren damit die Auflösungen aller verwendeten Monitore miteingeschlossen sind.
